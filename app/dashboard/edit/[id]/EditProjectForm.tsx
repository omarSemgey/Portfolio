  ...
  useEffect(() => {
    ...
    async function fetchProjectData() {
      try {
        ...
        console.error("Fetch manifest processing failure:", err);
      ...
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6 bg-surface p-6 md:p-8 rounded-xl border border-surface/50 shadow-xl">
          ...
          <button
            ...
            className="w-full bg-primary text-default font-bold p-3 rounded-lg shadow-md hover:bg-primary/90 hover:scale-[1.01] transition-all whitespace-nowrap border border-primary/20"
          >
